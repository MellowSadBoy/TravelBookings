...
public class HttpsUtils {
    ...
    public static String get(String url, String Authorization, String CompanyCode) throws ClientException {
        return pushRequestCurrent(url, null, "GET", Authorization, CompanyCode);
    }
...
//            logger.log(Level.INFO,"Result:" + result);
    ...
    private static String pushRequestCurrent(String urlRest, String body, String method, String token, String code) throws ClientException {
        HttpURLConnection conn = null;
        InputStream inputStream = null;
        BufferedReader inBuffer = null;
        try {
            ...
            if (null != token && token.length() > 0) {
                conn.setRequestProperty("CompanyCode", code);
            }
            conn.setConnectTimeout(120000);
            conn.setReadTimeout(120000);
            conn.setRequestMethod(method);
