...
import  logo_reverse from "~/assets/logo/Mellow_reverse.png";


export const Logo = ({logo, width, height, className}) => (
    <img
        alt="Mellow"
        src={logo}
        width={width}
...
export const LogoReverse = ({width, height, className}) => (
    <img alt="Mellow"
    src={logo_reverse}  width={width} height={height}
    className={className}/>
);