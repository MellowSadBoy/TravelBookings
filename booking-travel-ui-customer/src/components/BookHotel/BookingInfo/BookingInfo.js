...
const BookingInfo = (props) => {
    ...
    const {ageValues, hotel, children, adult,totalPrice} = props;
                ...
                <div className={cx("box-summary")}>
                    <div className={cx("summary-main")}>
                        <div className={cx("box-img")}>
                            <img src={hotel.featureImgUrl} alt={hotel?.name}/>
                        </div>
                    ...
                    <div className={cx("summary-total")}>
                        <table className={cx("tlb-info")}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className={cx("info-right")}> {hotel.id} </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div className={cx("info-right")}>{DateUtils.formatDate(hotel?.startDate)}  </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
